...
class Settings(BaseSettings):
    ...
    # ML tables (generated by data_science pipeline)
    table_wallet_fraud_scores: str = "wallet_fraud_scores"
    table_wallet_features: str = "wallet_features"
    
    # Raw dataset for dashboard queries
    bigquery_dataset_raw: str = "blockchain_raw"
